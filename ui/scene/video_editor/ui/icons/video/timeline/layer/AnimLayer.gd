...
func make_layer_ui():
	...
	var instance = preload("res://ui/scene/video_editor/ui/theme/instances/layer.tscn").instantiate(PackedScene.GEN_EDIT_STATE_MAIN)
	...
	var icon_texture = instance.get_node("LayerTagSplit/LayerTag/MarginContainer/HBoxContainer/TypeIcon")
	...
	icon_texture.modulate = color
	
	title_label.text = tag
	
	ui = instance.duplicate()
